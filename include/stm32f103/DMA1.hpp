...
private:
    static constexpr std::uintptr_t Address = 0x40020000;
...
private:
    static constexpr std::uintptr_t Address = 0x40020004;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020008;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4002000c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020010;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020014;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4002001c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020020;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020024;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020028;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020030;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020034;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020038;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x4002003c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020044;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020048;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x4002004c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020050;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020058;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x4002005c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020060;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020064;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x4002006c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020070;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020074;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020078;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020080;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_EN = CortexM3::Field<ValueType, 0, 1>;
    using F_TCIE = CortexM3::Field<ValueType, 1, 1>;
    using F_HTIE = CortexM3::Field<ValueType, 2, 1>;
...
private:
    static constexpr std::uintptr_t Address = 0x40020084;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_NDT = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40020088;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_PA = CortexM3::Field<ValueType, 0, 32>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x4002008c;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_MA = CortexM3::Field<ValueType, 0, 32>;
};
