...
private:
    static constexpr std::uintptr_t Address = 0x40013800;
...
private:
    static constexpr std::uintptr_t Address = 0x40013804;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013808;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4001380c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013810;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013814;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013818;
    using Reg = CortexM3::Register<ValueType, Address>;
