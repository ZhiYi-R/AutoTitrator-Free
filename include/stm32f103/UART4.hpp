...
private:
    static constexpr std::uintptr_t Address = 0x40004c00;
...
private:
    static constexpr std::uintptr_t Address = 0x40004c04;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40004c08;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40004c0c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40004c10;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40004c14;
    using Reg = CortexM3::Register<ValueType, Address>;
