...
private:
    static constexpr std::uintptr_t Address = 0x40012800;
...
private:
    static constexpr std::uintptr_t Address = 0x40012804;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012808;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4001280c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012810;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012814;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012818;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4001281c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012820;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012824;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012828;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4001282c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012830;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012834;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012838;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x4001283c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40012840;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40012844;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40012848;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x4001284c;
    using Reg = CortexM3::Register<ValueType, Address>;
