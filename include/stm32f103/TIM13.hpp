...
private:
    static constexpr std::uintptr_t Address = 0x40001c00;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c04;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c0c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c10;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c14;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c18;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c20;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c24;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c28;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c2c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40001c34;
    using Reg = CortexM3::Register<ValueType, Address>;
