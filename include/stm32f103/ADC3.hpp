...
private:
    static constexpr std::uintptr_t Address = 0x40013c00;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c04;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c08;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c0c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c10;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c14;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c18;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c1c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c20;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c24;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c28;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c2c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c30;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c34;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c38;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c3c;
    using Reg = CortexM3::Register<ValueType, Address>;
...
private:
    static constexpr std::uintptr_t Address = 0x40013c40;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40013c44;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40013c48;
    using Reg = CortexM3::Register<ValueType, Address>;
    using F_JDATA = CortexM3::Field<ValueType, 0, 16>;
};
...
private:
    static constexpr std::uintptr_t Address = 0x40013c4c;
    using Reg = CortexM3::Register<ValueType, Address>;
